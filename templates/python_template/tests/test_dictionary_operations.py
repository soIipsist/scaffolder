...
class TestDictionaryUtils(TestBase):
    def setUp(self) -> None:
        super().setUp()
        self.nested_dict = {"person": {"name": "red", "surname": "f"}}
        self.test_dict = {"person": "hi", "read": "write"}
        self.test_dict2 = {"person": "hi", "h": "b"}

        self.dict_list = [self.test_dict2, self.test_dict]
